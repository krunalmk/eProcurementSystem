...
<head>
    ...
    <script>
        ...
        function displayOpenTenders( responseInJSON){
            ...
            txt += "<tr><th>Tender ID</th><th>Reference</th><th>Posted company ID</th><th>Contract title</th><th>Date due</th><th>Date invited</th><th>Description</th><th>Conditions</th><th>Estimated time</th><th>Apply now</th></tr>";
            for (x in responseInJSON) {
                if( responseInJSON[x].open_close){
                    txt += "<tr><td>" + responseInJSON[x].tender_id + 
                            ...
                            "</td><td>" + responseInJSON[x].comp_id_owner +
                            "</td><td>" + responseInJSON[x].contracttitle +
