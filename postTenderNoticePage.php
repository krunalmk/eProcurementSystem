...
<head>
    ...
    <script>
        ...
        async function formOperation(event){
            ...
            var postInfo = "chosencategory="+ chosencategory + "&contracttitle="+ contracttitle+ "&description="+ description+ "&reference="+ reference+ "&estimatedtime="+ estimatedtime+ 
                            "&agreementvalue="+ agreementvalue+ "&dateinvited="+ dateinvited+ "&datedue="+ "&conditions="+ conditions;
